...
python3 main.py --config ./config/gsl_openpose/train_joint.yaml --work-dir pretrain_eval/gsl_openpose --half --amp-opt-level 2  --batch-size 16 --forward-batch-size 8 --device 0
