...
#python3 main.py --config ./config/gsl_mediapipe/train_joint.yaml --work-dir pretrain_eval/gsl_mediapipe --half --amp-opt-level 2  --batch-size 16 --forward-batch-size 8 --device 0
