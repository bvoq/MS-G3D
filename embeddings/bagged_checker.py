...
def getAndPrintResults(method, baggingcount):
...
getAndPrintResults("SVC", baggingcount)
getAndPrintResults("GaussianProcessClassifier", baggingcount)
getAndPrintResults("DecisionTreeClassifier", baggingcount)
getAndPrintResults("RandomForestClassifier", baggingcount)
getAndPrintResults("MLPClassifier", baggingcount)
getAndPrintResults("AdaBoostClassifier", baggingcount)
getAndPrintResults("GaussianNB", baggingcount)
getAndPrintResults("QuadraticDiscriminantAnalysis", baggingcount)
