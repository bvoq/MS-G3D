...
python3 main2.py --config ./config/gsl_mediapipe/embed_embed_joint.yaml --work-dir pretrain_eval/gsl_mediapipe_wbg_newmethod --half --amp-opt-level 2  --batch-size 16 --forward-batch-size 8 --device 0
