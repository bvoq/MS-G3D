...
python3 main2.py --config ./config/gsl_mediapipe/embed_embed_joint.yaml --weights ./pretrained-models/gsl-mediapipe-wbg-newmethod-cross-joint.pt --work-dir pretrain_eval/gsl_mediapipe_standard --half --amp-opt-level 2  --batch-size 16 --forward-batch-size 8 --device 0
